...
public class TicTacToe extends javax.swing.JFrame {
    ...
    private void winningGame()
    {
        ...
        // check if "X" is a winner in row 1
        if(b1 == ("X") && b2 == ("X") && b3 == ("X"))
        {
            JOptionPane.showMessageDialog(this, "Player X wins", "Tic Tac To", JOptionPane.INFORMATION_MESSAGE);
            xCount++;
            gameScore();
        ...
        // check if "X" is a winner in row 2
        if(b4 == ("X") && b5 == ("X") && b6 == ("X"))
        {
            JOptionPane.showMessageDialog(this, "Player X wins", "Tic Tac To", JOptionPane.INFORMATION_MESSAGE);
            xCount++;
        ...
        // check if "X" is a winner in row 3
        if(b7 == ("X") && b8 == ("X") && b9 == ("X"))
        {
            JOptionPane.showMessageDialog(this, "Player X wins", "Tic Tac To", JOptionPane.INFORMATION_MESSAGE);
            xCount++;
        ...
        // check if "X" is a winner in column 1
        if(b1 == ("X") && b4 == ("X") && b7 == ("X"))
        {
            JOptionPane.showMessageDialog(this, "Player X wins", "Tic Tac To", JOptionPane.INFORMATION_MESSAGE);
            xCount++;
        ...
        // check if "X" is a winner in column 2
        if(b2 == ("X") && b5 == ("X") && b8 == ("X"))
        {
            JOptionPane.showMessageDialog(this, "Player X wins", "Tic Tac To", JOptionPane.INFORMATION_MESSAGE);
            xCount++;
        ...
        // check if "X" is a winner in column 3
        if(b3 == ("X") && b6 == ("X") && b9 == ("X"))
        {
            JOptionPane.showMessageDialog(this, "Player X wins", "Tic Tac To", JOptionPane.INFORMATION_MESSAGE);
            xCount++;
        ...
        // check if "X" is a winner diagonally, top left to bottom
        if(b1 == ("X") && b5 == ("X") && b9 == ("X"))
        {
            JOptionPane.showMessageDialog(this, "Player X wins", "Tic Tac To", JOptionPane.INFORMATION_MESSAGE);
            xCount++;
        ...
        // check if "X" is a winner diagonally, top right to bottom
        if(b3 == ("X") && b5 == ("X") && b7 == ("X"))
        {
            JOptionPane.showMessageDialog(this, "Player X wins", "Tic Tac To", JOptionPane.INFORMATION_MESSAGE);
            xCount++;
        ...
        // check if "O" is a winner in row 1
        if(b1 == ("O") && b2 == ("O") && b3 == ("O"))
        {
            JOptionPane.showMessageDialog(this, "Player O wins", "Tic Tac To", JOptionPane.INFORMATION_MESSAGE);
            oCount++;
            gameScore();
            jButton1.setBackground(Color.YELLOW);
            jButton2.setBackground(Color.YELLOW);
        ...
        // check if "O" is a winner in row 2
        if(b4 == ("O") && b5 == ("O") && b6 == ("O"))
        {
            JOptionPane.showMessageDialog(this, "Player O wins", "Tic Tac To", JOptionPane.INFORMATION_MESSAGE);
            oCount++;
        ...
        // check if "O" is a winner in row 3
        if(b7 == ("O") && b8 == ("O") && b9 == ("O"))
        {
            JOptionPane.showMessageDialog(this, "Player O wins", "Tic Tac To", JOptionPane.INFORMATION_MESSAGE);
            oCount++;
        ...
        // check if "O" is a winner in column 1
        if(b1 == ("O") && b4 == ("O") && b7 == ("O"))
        {
            JOptionPane.showMessageDialog(this, "Player O wins", "Tic Tac To", JOptionPane.INFORMATION_MESSAGE);
            oCount++;
        ...
        // check if "O" is a winner in column 2
        if(b2 == ("O") && b5 == ("O") && b8 == ("O"))
        {
            JOptionPane.showMessageDialog(this, "Player O wins", "Tic Tac To", JOptionPane.INFORMATION_MESSAGE);
            oCount++;
        ...
        // check if "O" is a winner in column 3
        if(b3 == ("O") && b6 == ("O") && b9 == ("O"))
        {
            JOptionPane.showMessageDialog(this, "Player O wins", "Tic Tac To", JOptionPane.INFORMATION_MESSAGE);
            oCount++;
        ...
        // check if "O" is a winner diagonally, top left to bottom
        if(b1 == ("O") && b5 == ("O") && b9 == ("O"))
        {
            JOptionPane.showMessageDialog(this, "Player O wins", "Tic Tac To", JOptionPane.INFORMATION_MESSAGE);
            oCount++;
        ...
        // check if "O" is a winner diagonally, top right to bottom
        if(b3 == ("O") && b5 == ("O") && b7 == ("O"))
        {
            JOptionPane.showMessageDialog(this, "Player O wins", "Tic Tac To", JOptionPane.INFORMATION_MESSAGE);
            oCount++;
    ...
    private void initComponents() {
        ...
        jLabel1.setFont(new java.awt.Font("Tahoma", 2, 100)); // NOI18N
